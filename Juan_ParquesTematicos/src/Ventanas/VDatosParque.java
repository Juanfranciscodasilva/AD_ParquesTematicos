...
public class VDatosParque extends javax.swing.JFrame {
    ...
    public VDatosParque(Parque parque) {
        initComponents();
        setLocationRelativeTo(null);
        tNombre.setText(parque.getNombre());
        tDireccion.setText(parque.getDireccion());
        DateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
        tFechaApertura.setText(formato.format(parque.getFecha_apertura()));
    }
    ...
    private void initComponents() {
        ...
        tTitulo.setText("Datos del Parque");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VDatosParque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VDatosParque().setVisible(true);
            }
        });
    }
